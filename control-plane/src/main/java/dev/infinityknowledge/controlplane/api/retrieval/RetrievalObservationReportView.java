...
public record RetrievalObservationReportView(
    ...
    public record MetricDimensionsView(
            ...
            /** PostgreSQL 旧物化列的兼容字段，值始终与 technicalStatus 相同。 */
            String status,
            String stopReason,
            String purpose,
            String timeSlice
        ...
        private static MetricDimensionsView from(MetricDimensions dimensions) {
            ...
            return new MetricDimensionsView(
                    ...
                    values.get(MetricDimensions.Key.VISIT_INDEX),
                    values.get(MetricDimensions.Key.STAGE),
                    values.get(MetricDimensions.Key.CHANNEL),
                    values.get(MetricDimensions.Key.CHAIN_NODE),
                    values.get(MetricDimensions.Key.COMPONENT_MODEL),
                    values.get(MetricDimensions.Key.DATA_INDEX_VERSION),
                    values.get(MetricDimensions.Key.COVERAGE_STATUS),
                    values.get(MetricDimensions.Key.TECHNICAL_STATUS),
                    values.get(MetricDimensions.Key.TERMINAL_STATUS),
