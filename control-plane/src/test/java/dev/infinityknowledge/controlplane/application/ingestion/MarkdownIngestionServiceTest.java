...
import dev.infinityknowledge.controlplane.application.ingestion.DocumentIngestionPipeline;
...
class MarkdownIngestionServiceTest {
    ...
    private static MarkdownIngestionService service(
        ...
        var parserLimits = new FileIngestionProperties(
                1_048_576,
                4_194_304,
                50,
                1_000,
        ...
        var pipeline = new DocumentIngestionPipeline(
                ...
                IngestionPipelineTestConfigs.structural(parsers, 512, 1_024),
                parserLimits
        );
